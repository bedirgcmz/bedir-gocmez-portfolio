...
export default function HireMeButton() {
    ...
    return (
      <a
        ...
        className="inline-block bg-[var(--color-active)] dark:bg-[var(--color-active-darker)] flex gap-2 items-center justify-center text-white font-semibold w-[140px] px-6 py-3 rounded-full shadow-md hover:scale-105 transform transition duration-300"
      >
