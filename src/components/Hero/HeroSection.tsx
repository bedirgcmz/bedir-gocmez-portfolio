...
export default function HeroSection() {
  return (
    ...
    <ParticlesBackground />
    <section
      className={`relative flex flex-col md:flex-row gap-6 max-w-[1600px] m-auto items-center justify-around text-center h-[100vh] px-4 `}
    >
        <div className='flex flex-col justify-between items-center md:items-start w-[90%] md:w-[51%] max-w-[600px]'>
            <div className='flex flex-col items-center md:flex-row items-centr justify-between'>
                <TouchMeSidebar />
                <div className='flex items-center md:items-start flex-col'>
                    <h1 className="w-full max-xs:text-3xl text-4xl md:text-5xl font-bold mb-4 z-10 md:text-left text-[#1a7b81] dark:text-[var(--color-active)] ">
                        Hi There, I’m{' '} <br />
                    ...
                    <div className='flex gap-6 items-center'>
                        <a href="#about" className="bg-[var(--color-active)] dark:bg-[var(--color-active-darker)] max-xs:px-1 max-xs:py-1 flex gap-2 items-center justify-center text-white w-[140px] px-2 py-3 rounded-full z-10 hover:scale-105 transition font-semibold">
